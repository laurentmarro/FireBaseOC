package fr.outlook.marro.laurent.firebaseoc.mentor_chat;
...
public class MentorChatActivity extends AppCompatActivity implements MentorChatAdapter.Listener {
    ...
    private void configureRecyclerView(String chatName){
        ...
        this.mentorChatAdapter = new MentorChatAdapter(generateOptionsForAdapter(MessageHelper.
                getAllMessageForChat(this.currentChatName)), Glide.with(this),
                this, this.getCurrentUser().getUid());
