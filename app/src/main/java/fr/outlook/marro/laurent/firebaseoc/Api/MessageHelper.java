...
public class MessageHelper {
    ...
    // --- CREATE ---
    public static Task<DocumentReference> createMessage(String userId, String receiverID, String currentTime, String time, String image_sender_url, String image_to_send, String message){
